...
u_list = open('cc_aqua_202108_url.txt')
directory="."
ctr=0
...
select
 *,
 cast('aqua' as varchar) sat_name_part,
...
#    gzipFileName   = outputFileName + '.gz'
    ...
    s3dest         = 's3://nasa-ems-sandbox/staging/science/climcaps/aqua/'
#    d = Dataset(filename, 'r')
#    #d.set_auto_maskandscale(True)
    print (inputFileName, outputFileName, workPath, s3dest)
    subprocess.run(["python", "aqua_climcaps_l2_to_avro.py", inputFileName, outputFileName])
